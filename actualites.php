<?php
    ...
    $sub_nav = array("Actualités des Gentils Virus", "Modifications du site", "Modifications du wiki", "Évèments listés dans le wiki");
...
<article>
			<h1>Actualit&eacute;s des Gentils Virus</h1>
